...
def test_cli_list_filenames_immediate_historical(capsys):
    ...
    assert_equal(response[0], "PH_Sofortmelder_Landwirtschaft_Kulturpflanze_Dauergruenland_1979_2018_hist.txt")
    assert_equal(response[-1], "PH_Sofortmelder_Wildwachsende_Pflanze_Wiesen-Fuchsschwanz_1979_2024_hist.txt")
...
def test_cli_list_filenames_annual_historical(capsys):
    ...
    assert_equal(response[0], "PH_Jahresmelder_Landwirtschaft_Kulturpflanze_Dauergruenland_1936_2018_hist.txt")
    assert_equal(response[-1], "PH_Jahresmelder_Wildwachsende_Pflanze_Zweigriffliger_Weissdorn_1936_2024_hist.txt")
